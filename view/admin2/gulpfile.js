...
gulp.task('less', function() {
    return gulp.src(['less/sb-admin-2.less', 'less/main.less'])
        .pipe(less())
...
gulp.task('minify-css', ['less'], function() {
    return gulp.src(['dist/css/sb-admin-2.css', 'dist/css/main.css'])
...
gulp.task('js', function() {
    return gulp.src(['js/sb-admin-2.js', 'js/main.js'])
        .pipe(header(banner, { pkg: pkg }))
...
gulp.task('copy', function() {
    ...
    gulp.src(['bower_components/vis/dist/vis.js', 'bower_components/vis/dist/vis.css'])
